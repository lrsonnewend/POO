...
public class server_frame extends javax.swing.JFrame 
{
   ...
   public class ClientHandler implements Runnable	
   {
      ...
      return texto.toString();
       ...
       public void run() 
       {
            ...
            try 
            {
                ...
                {
                    String crip = encriptar(chaveCrip,message);
                    String descrip = decriptar(chaveCrip, crip);
                    
                    ta_chat.append("Recebido (criptografado): " + crip + "\n");
                    data = message.split(":");
                    
                    ta_chat.append("Recebido (descriptografa): " + descrip + "\n");
                    data = message.split(":");
                    ...
                    {
                        tellEveryone((data[0] + ":Se desconectou." + ":" + chat));
                        userRemove(data[0]);
                    } 
                    ...
                    {
                        ta_chat.append("Erro desconhecido. \n");
                    }
                } 
             } 
             catch (Exception ex) 
             {
                ta_chat.append("Perdeu a conexão. \n");
                ex.printStackTrace();
    ...
    private void initComponents() {
        ...
        b_end.setText("Encerrar Servidor");
    ...
    private void b_endActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_b_endActionPerformed
        ...
        tellEveryone("Server:Está sendo desligado e todos usuários serão desconectados.\n:Chat");
        ta_chat.append("Servidor desligando... \n");
    ...
    {
        String message, add = ": :Conectado", done = "Servidor: :Feito", name = data;
	...
	Iterator it = clientOutputStreams.iterator();
		...
		ta_chat.append("Enviando: " + message + "\n");
            ...
            {
		ta_chat.append("Erro ao comunicar todos. \n");
            }
        } 
    }
