...
public class client_frame extends javax.swing.JFrame 
{
    ...
    {
         ta_chat.append(data + " Está desconectado.\n");
    }
    ...
    {
        String bye = (username + ": :Descontado");
        try
        {
            writer.println(bye); 
            writer.flush(); 
        ...
        {
            ta_chat.append("Não é possível enviar mensagem quando se está desconectado, troxa.\n");
        }
    }
    ...
    public class IncomingReader implements Runnable
    {
        ...
        {
            String[] data;
            String stream, done = "Feito", connect = "Conectado", disconnect = "Desconectado", chat = "Chat";
    ...
    private void initComponents() {
        ...
        lb_username.setText("Nome usuário:");
        ...
        b_anonymous.setText("Login anônimo");
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addComponent(b_send, javax.swing.GroupLayout.DEFAULT_SIZE, 130, Short.MAX_VALUE))
    ...
    private void b_connectActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_b_connectActionPerformed
        if (isConnected == false) 
        {
            ...
            try 
            {
                ...
                writer.println(username + ":Conectgou-se.:Conectado");
                writer.flush(); 
                isConnected = true; 
            } 
            catch (Exception ex) 
            {
                ta_chat.append("Não foi possível conectar, tente novamente. \n");
                tf_username.setEditable(true);
            }
    ...
    private void b_anonymousActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_b_anonymousActionPerformed
        ...
        if (isConnected == false) 
        {
            ...
            try 
            {
                ...
                reader = new BufferedReader(streamreader);
                writer = new PrintWriter(sock.getOutputStream());
                writer.println(anon + ":Se conectou.:Conectado");
                writer.flush(); 
                isConnected = true; 
            } 
            catch (Exception ex) 
            {
                ta_chat.append("Não foi possível se conectar, tente novamente. \n");
                tf_username.setEditable(true);
            }
